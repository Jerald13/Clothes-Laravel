                ...
                <div class="col-auto">
                  <form class="form-inline">
                    ...
                    <div class="form-group">
                      <button type="button" class="btn btn-sm"><span class="{{ 'fe-refresh-ccw fe-16 text-muted' }}"></span></button>
                      <button type="button" class="btn btn-sm mr-2"><span class="{{ 'fe-filter fe-16 text-muted' }}"></span></button>
                    </div>
                  </form>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    <div class="row mt-1 align-items-center">
                      <div class="col-12 col-lg-4 text-left pl-4">
                        ...
                        <span class="{{ 'fe-arrow-up text-success fe-12' }}"></span>
                      ...
                      <div class="col-6 col-lg-2 text-center py-4 mb-2">
                        ...
                        <span class="{{ 'fe-arrow-up text-success ' }}"></span>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4">
                      ...
                      <div class="col-6 col-lg-2 text-center py-4">
                        ...
                        <span class="{{ 'fe-arrow-down text-danger ' }}"></span>
                      </div>
                    </div>
              ...
              <div class="modal-body">
                <div class="list-group list-group-flush my-n3">
                  ...
                  <div class="list-group-item bg-transparent">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <span class="{{ 'fe-download fe' }}"></span>
                      </div>
                      <div class="col">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body px-5">
                <div class="row align-items-center">
                  <div class="col-6 text-center">
                    <div class="squircle bg-success justify-content-center">
                      <i class="{{ 'fe-cpu fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Control area</p>
                  </div>
                  <div class="col-6 text-center">
                    <div class="squircle bg-primary justify-content-center">
                      <i class="{{ 'fe-activity fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Activity</p>
                  </div>
                </div>
                <div class="row align-items-center">
                  <div class="col-6 text-center">
                    <div class="squircle bg-primary justify-content-center">
                      <i class="{{ 'fe-droplet fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Droplet</p>
                  </div>
                  <div class="col-6 text-center">
                    <div class="squircle bg-primary justify-content-center">
                      <i class="{{ 'fe-upload-cloud fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Upload</p>
                  </div>
                </div>
                <div class="row align-items-center">
                  <div class="col-6 text-center">
                    <div class="squircle bg-primary justify-content-center">
                      <i class="{{ 'fe-users fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Users</p>
                  </div>
                  <div class="col-6 text-center">
                    <div class="squircle bg-primary justify-content-center">
                      <i class="{{ 'fe-settings fe-32 align-self-center ' }}"></i>
                    </div>
                    <p>Settings</p>
                  </div>
                </div>
