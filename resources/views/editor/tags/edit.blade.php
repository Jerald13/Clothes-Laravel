    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Form Edit Category</h2>
              <p class="text-muted">Edit category such as Women, Men, Bag, Shoes, Watches.</p>
              <div class="row justify-content-center">
                <div class="col-md-6" style="width: 1000px; max-width:100%;">
                  <div class="card shadow mb-4" style="width: 1000px;">
                    ...
                    <div class="card-body">
                      <form class="needs-validation" action="{{ route('tags.update',$tag->id) }}" method="POST" novalidate>
                        @csrf
                        @method('put')
                        <div class="form-group mb-3">
                            <label for="address-wpalaceholder">Name</label>
                            <input type="text" id="address-wpalaceholder"  class="form-control" name="name" value="{{old('name',$tag->name)}}" placeholder="Enter your category name" required="">
                            <div class="valid-feedback"> Looks good! </div>
                            <div class="invalid-feedback"> Badd address </div>
                          </div>
                     
                          <input type="hidden" name="status" value="{{ old('name',$tag->status) }}">
