      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            ...
            <div class="row">
                <div class="col-9">
                  <p class="text-muted">Display order status with username, email, phone number, shipping address, order total. For those who order items that are paid,shipped,received,rated, then the Editor or Admin able update order status.</p>
                </div>
                ...
                <div id="uploadModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form id="uploadForm" action="{{ route('orders.import.xml') }}" method="post" style="justify-content: center;margin: auto;text-align: left;">
                            @csrf
                  ...
                  <a href="{{ route('orders.export.xml') }}"><button class="btn btn-primary" >Export XML File</button></a>
                </div>
              </div>
