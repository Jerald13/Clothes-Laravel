    ...
    <main role="main" class="main-content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            <h2 class="mb-2 page-title">Admin & Editor Data table</h2>

            <div class="row">
                <div class="col-9">
                  <p class="text-muted">Display user banned who behave rude on review module. Admin able to ban editor</p>
                </div>
            </div>
