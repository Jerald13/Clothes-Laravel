                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                            <li class="nav-item active">
                                <a class="nav-link pl-3" href="index"><span
                            ...
                            <ul class="navbar-nav flex-fill w-100 mb-2">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="collapse list-unstyled pl-4 w-100" id="Report">
                                        <li class="nav-item">
                                            <a class="nav-link pl-3" href="productDisplay"><span
                                                    class="ml-1 item-text">Display Report</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <ul class="collapse list-unstyled pl-4 w-100" id="Order">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link pl-3"
                                                    href="{{ route('orders.display.xsl') }}"><span
                                                        class="ml-1 item-text">Display Order In XSL</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link pl-3"
                                                    href="{{ route('orders.display.xml') }}"><span
                                                        class="ml-1 item-text">Display Order In XML</span>
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <ul class="navbar-nav flex-fill w-100 mb-2">
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="collapse list-unstyled pl-4 w-100" id="User">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link pl-3"
                                                        href="{{ route('users.display.xsl') }}"><span
                                                            class="ml-1 item-text">Display User In XSL</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link pl-3"
                                                        href="{{ route('users.display.xml') }}"><span
                                        ...
                                        <ul class="navbar-nav flex-fill w-100 mb-2">
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="collapse list-unstyled pl-4 w-100" id="Role">
                                                    <li class="nav-item">
                                                        <a class="nav-link pl-3"
                                                            href="{{ route('role.displayRole') }}"><span
                                                                class="ml-1 item-text">Display Role</span>
                                                        </a>
                                                        <a class="nav-link pl-3"
                                                            href="{{ route('role.AddEditor') }}"><span
