              ...
              <div class="row justify-content-center">
                <div class="col-md-6" style="width: 1000px; max-width:100%;">
                  <div class="card shadow mb-4" style="width: 1000px;">
                    ...
                    <div class="card-body">
                      <form class="needs-validation" action="{{ route('categories.update',$category->id) }}" method="POST" novalidate>
                        @csrf
                        @method('put')
                        <div class="form-group mb-3">
                            <label for="address-wpalaceholder">Name</label>
                            <input type="text" id="address-wpalaceholder"  class="form-control" name="name" value="{{old('name',$category->name)}}" placeholder="Enter your category name" required="">
