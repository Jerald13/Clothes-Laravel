                        ...
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            ...
                            <div class="p-t-33">
                                ...
                                <script>
                                    ...
                                    let inputQuantityElement = document.getElementById('inputQuantity');
                                        ...
                                        if (event.target.id === 'size') {
                                            ...
                                            fetch('/get-quantity?color=' + color + '&size=' + size + '&productId=' + productId)
                                                ...
                                                .then(quantity => {
                                                    ...
                                                    inputQuantityElement.max = result.quantity; // set max attribute
                                                })
                                    ...
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            ...
                                            <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                id="inputQuantity" name="num-product" value="1" min="1">
